export const dessertList = [
  ...
  {
    MealName: "Air Fryer Molten Lava Cake",
    MealPrice: "$110",
    MealDesc:
  ...
  {
    MealName: "Crustless Air Fryer Cheesecake",
    MealPrice: "$100",
    MealDesc:
...
export const soapList = [
  ...
  {
    MealName: "Tuscan Tortellini Soup",
    MealPrice: "$330",
    MealDesc:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum pretium diam orci, a ultrices enim tincidunt nec.",
    MealImage:
...
export const mealList = [
  ...
  {
    MealName: "Cumin Spiced Chicken Meatballs",
    MealPrice: "$90",
    MealDesc:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum pretium diam orci, a ultrices enim tincidunt nec.",
    MealImage:
